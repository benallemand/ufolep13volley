...
try {
    ...
    header('Location: /new_site/#/login?redirect=' . urlencode(filter_input(INPUT_SERVER, 'REQUEST_URI')) . '&reason=' . $e->getMessage());
    exit(0);
}
try {
...
<HEAD>
    ...
    <script
            ...
            type="text/javascript"></script>
    <script
            type="text/javascript" src="js/survey.js"></script>
