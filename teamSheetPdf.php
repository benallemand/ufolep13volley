...
$pdf->Cell(35, 5, $jsonMyTeam[0]->club, 0, 1, 'L');
$pdf->Cell(20, 5, 'Championnat: ', 0, 0, 'L');
$pdf->Cell(35, 5, $jsonMyTeam[0]->championnat, 0, 1, 'L');
$pdf->Cell(20, 5, 'Division: ', 0, 0, 'L');
$pdf->Cell(35, 5, $jsonMyTeam[0]->division, 0, 1, 'L');
$pdf->Cell(20, 5, 'Capitaine: ', 0, 0, 'L');
$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell(35, 5, $jsonMyTeam[0]->capitaine, 0, 1, 'L');
$pdf->SetFont('Arial', '', 8);
$pdf->Cell(20, 5, 'Portable: ', 0, 0, 'L');
$pdf->Cell(35, 5, $jsonMyTeam[0]->portable, 0, 1, 'L');
$pdf->Cell(20, 5, 'Courriel: ', 0, 0, 'L');
$pdf->Cell(35, 5, $jsonMyTeam[0]->courriel, 0, 1, 'L');
$pdf->Cell(20, 5, 'Créneau: ', 0, 0, 'L');
$pdf->Cell(35, 5, $jsonMyTeam[0]->creneau, 0, 1, 'L');
$pdf->Cell(20, 5, 'Gymnase: ', 0, 0, 'L');
$pdf->Cell(35, 5, $jsonMyTeam[0]->gymnase, 0, 1, 'L');
...
$pdf->Cell(50, 10, $jsonMyTeam[0]->equipe, 1, 1, 'C');
$pdf->SetFont('Arial', '', 8);
$pdf->SetXY(100, 50);
$pdf->Cell(40, 5, 'Visa CTSD le: ' . $jsonMyTeam[0]->date_visa_ctsd, 0, 1, 'C');
$pdf->SetXY(150, 30);
