SELECT m.code_match,
       ...
       IF(m.is_sign_team_dom = 0,
          CONCAT('<a href=\'https://www.ufolep13volley.org/team_sheets.html?id_match=', m.id_match, '\'>non signée</a>'),
          'ok') AS is_sign_team_dom,
       IF(m.is_sign_team_ext = 0,
          CONCAT('<a href=\'https://www.ufolep13volley.org/team_sheets.html?id_match=', m.id_match, '\'>non signée</a>'),
          'ok') AS is_sign_team_ext,
       IF(m.is_sign_match_dom = 0,
          CONCAT('<a href=\'https://www.ufolep13volley.org/match.html?id_match=', m.id_match, '\'>non signée</a>'),
          'ok') AS is_sign_match_dom,
       IF(m.is_sign_match_ext = 0,
          CONCAT('<a href=\'https://www.ufolep13volley.org/match.html?id_match=', m.id_match, '\'>non signée</a>'),
          'ok') AS is_sign_match_ext,
       IF(m.is_survey_filled_dom = 0,
          CONCAT('<a href=\'https://www.ufolep13volley.org/survey.html?id_match=', m.id_match, '\'>non rempli</a>'),
