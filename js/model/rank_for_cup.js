Ext.define('Ufolep13Volley.model.rank_for_cup', {
    ...
    fields: [
        {name: 'rang', type: 'int'},
        {name: 'rang_poule', type: 'int'},
        {name: 'code_competition', type: 'string'},
        {name: 'division', type: 'string'},
        {name: 'nb_matchs', type: 'int'},
        {name: 'id_equipe', type: 'int'},
        {name: 'equipe', type: 'string'},
        {name: 'points', type: 'int'},
        {name: 'points_ponderes', type: 'float'},
        {name: 'diff_sets_ponderes', type: 'float'},
        {name: 'diff_points_ponderes', type: 'float'},
        {name: 'joues', type: 'int'},
