...
$sql->execute("DELETE FROM joueur_equipe WHERE id_equipe IN (SELECT id_equipe FROM equipes WHERE code_competition = 'zz')");
$sql->execute("DELETE FROM joueurs WHERE nom = 'REGLEADER'");
$sql->execute("DELETE FROM creneau WHERE id_equipe IN (SELECT id_equipe FROM equipes WHERE code_competition = 'zz')");
$sql->execute("DELETE FROM equipes WHERE code_competition = 'zz'");
$sql->execute("DELETE FROM gymnase WHERE nom = 'E2E Reg Gym'");
